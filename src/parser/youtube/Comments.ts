...
export default class Comments {
  ...
  constructor(actions: Actions, data: any, already_parsed = false) {
    ...
    const header_node = contents[0]?.as(AppendContinuationItemsAction, ReloadContinuationItemsCommand);
    const body_node = contents[1]?.as(AppendContinuationItemsAction, ReloadContinuationItemsCommand);
