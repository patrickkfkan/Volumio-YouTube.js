...
This is a bug, please report it at ${V.shim.info.bugs_url}`))}}static sanitizeClassName(e){return(e.charAt(0).toUpperCase()+e.slice(1)).replace(/Renderer|Model/g,"").replace(/Radio/g,"Mix").trim()}static shouldIgnore(e){return this.ignore_list.has(e)}static getParserByName(e){let i=u(this,W,"f",x_).get(e);if(!i){let n=new Error(`Module not found: ${e}`);throw n.code="MODULE_NOT_FOUND",n}return i}static hasParser(e){return u(this,W,"f",x_).has(e)}static addRuntimeParser(e,i){u(this,W,"f",x_).set(e,i),u(this,W,"f",E0).set(e,i)}static getDynamicParsers(){return Object.fromEntries(u(this,W,"f",E0))}};o(ne,"Parser");W=ne,kt=o(function(){T(ne,W,null,"f",Yi)},"_Parser_clearMemo"),St=o(function(){T(ne,W,new Ci,"f",Yi)},"_Parser_createMemo"),mw=o(function(e,i){if(!u(ne,W,"f",Yi))return;let n=u(ne,W,"f",Yi).get(e);if(!n)return u(ne,W,"f",Yi).set(e,[i]);n.push(i)},"_Parser_addToMemo"),It=o(function(){if(!u(ne,W,"f",Yi))throw new Error("Parser#getMemo() called before Parser#createMemo()");return u(ne,W,"f",Yi)},"_Parser_getMemo"),_w=o(function({classname:e,classdata:i,err:n}){if(n.code=="MODULE_NOT_FOUND")return console.warn(new v(`${e} not found!
