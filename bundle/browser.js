...
var Format = class {
  constructor(data2) {
    ...
    if (this.has_audio) {
      ...
      this.language = ((_b = (_a6 = url_components.get("xtags")) === null || _a6 === void 0 ? void 0 : _a6.split(":").find((x) => x.startsWith("lang="))) === null || _b === void 0 ? void 0 : _b.split("=")[1]) || null;
...
var ItemSection = class extends YTNode {
  constructor(data2) {
    ...
    if (data2.continuations) {
      this.continuation = (_c = (_b = (_a6 = data2.continuations) === null || _a6 === void 0 ? void 0 : _a6[0]) === null || _b === void 0 ? void 0 : _b.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation;
    }
  }
};
...
_MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  ...
  var _a6, _b;
  const is_video = (_b = (_a6 = this.flex_columns[1]) === null || _a6 === void 0 ? void 0 : _a6.key("title").instanceof(Text).runs) === null || _b === void 0 ? void 0 : _b.some((run) => run.text.match(/(.*?) views/));
  if (is_video) {
  ...
  var _a6, _b, _c, _d;
  this.name = this.flex_columns.first().key("title").instanceof(Text).toString();
  this.subtitle = (_a6 = this.flex_columns[1]) === null || _a6 === void 0 ? void 0 : _a6.key("title").instanceof(Text);
...
var VideoInfo = class extends MediaInfo_default {
  constructor(data2, actions, cpn) {
    var _a6, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15;
